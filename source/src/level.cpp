...
void Level::loadMap(std::string mapName, Graphics &graphics)
{
	...
	while (pTileset)
	{
		...
		XMLElement *pTileAnimations = pTileset->FirstChildElement("tile");

		while (pTileAnimations)
		{
			AnimatedTileInfo ati;
			ati.StartTileId = pTileAnimations->IntAttribute("id") + firstgid;
			ati.TilesetsFirstGid = firstgid;
			XMLElement *pAnimation = pTileAnimations->FirstChildElement("animation");
			...
			pTileAnimations = pTileAnimations->NextSiblingElement("tile");
		}
